...
**FIG8. 3D periodic orbits of general three-body problem: (a) $O_{2}(1.2)$, (b) $O_{8}(0.6)$, (c) $O_{3}(1.0)$, (d) $O_{4}(1.0)$, (e) $O_{6}(1.0)$, (f) $O_{6}(1.2)$. Blue circle: Body-1; Red circle: Body-2; Green circle: Body-3.**
...
**FIG10. 3D “piano-trio orbits” of three-body problem with two bodies (m<sub>1</sub>=m<sub>2</sub>=1) moving along a single closed orbit (red) but the third (m<sub>3</sub> $\neq$ 1) along a distinct orbit (green): (a) $O_{6}(0.6)$, (b) $O_{26}(1.1)$, (c) $O_{48}(0.5)$, (d) $O_{267}(0.9)$. Blue circle: Body-1 (m<sub>1</sub>=1); Red circle: Body-2 (m<sub>2</sub>=1); Green circle: Body-3 (m<sub>3</sub> $\neq$ 1).**
